...
func easyjson390b7126DecodeGithubComChancedPicker35(in *jlexer.Lexer, out *BoundingBox) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker35(out *jwriter.Writer, in BoundingBox) {
	out.RawByte('{')
	first := true
	_ = first
	{
