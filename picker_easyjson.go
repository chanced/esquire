...
import (
	json "encoding/json"
	dynamic "github.com/chanced/dynamic"
...
func easyjson390b7126DecodeGithubComChancedPicker1(in *jlexer.Lexer, out *wildcardField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker1(out *jwriter.Writer, in wildcardField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.NullValue != nil {
...
// MarshalJSON supports json.Marshaler interface
func (v wildcardField) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v wildcardField) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson390b7126EncodeGithubComChancedPicker1(w, v)
}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *wildcardField) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson390b7126DecodeGithubComChancedPicker1(l, v)
}
func easyjson390b7126DecodeGithubComChancedPicker2(in *jlexer.Lexer, out *termsSetQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker2(out *jwriter.Writer, in termsSetQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker4(in *jlexer.Lexer, out *simpleQueryStringQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker4(out *jwriter.Writer, in simpleQueryStringQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker5(in *jlexer.Lexer, out *sigmoidFunction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "pivot":
			if m, ok := out.Pivot.(easyjson.Unmarshaler); ok {
				m.UnmarshalEasyJSON(in)
			} else if m, ok := out.Pivot.(json.Unmarshaler); ok {
				_ = m.UnmarshalJSON(in.Raw())
			} else {
				out.Pivot = in.Interface()
			}
		case "exponent":
			if m, ok := out.Exponent.(easyjson.Unmarshaler); ok {
				m.UnmarshalEasyJSON(in)
			} else if m, ok := out.Exponent.(json.Unmarshaler); ok {
				_ = m.UnmarshalJSON(in.Raw())
			} else {
				out.Exponent = in.Interface()
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson390b7126EncodeGithubComChancedPicker5(out *jwriter.Writer, in sigmoidFunction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Pivot != nil {
		const prefix string = ",\"pivot\":"
		first = false
		out.RawString(prefix[1:])
		if m, ok := in.Pivot.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.Pivot.(json.Marshaler); ok {
			out.Raw(m.MarshalJSON())
		} else {
			out.Raw(json.Marshal(in.Pivot))
		}
	}
	if in.Exponent != nil {
		const prefix string = ",\"exponent\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		if m, ok := in.Exponent.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.Exponent.(json.Marshaler); ok {
			out.Raw(m.MarshalJSON())
		} else {
			out.Raw(json.Marshal(in.Exponent))
		}
	}
	out.RawByte('}')
}
...
func easyjson390b7126DecodeGithubComChancedPicker6(in *jlexer.Lexer, out *shapeQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker6(out *jwriter.Writer, in shapeQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker7(in *jlexer.Lexer, out *saturationFunction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker7(out *jwriter.Writer, in saturationFunction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Pivot != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker8(in *jlexer.Lexer, out *rankFeatureQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "log":
			if in.IsNull() {
				...
				if out.Log == nil {
					out.Log = new(LogFunction)
				}
				if data := in.Raw(); in.Ok() {
					in.AddError((*out.Log).UnmarshalJSON(data))
				}
			}
		case "linear":
			if in.IsNull() {
				...
				if out.Linear == nil {
					out.Linear = new(LinearFunction)
				}
				if data := in.Raw(); in.Ok() {
					in.AddError((*out.Linear).UnmarshalJSON(data))
				}
			}
		case "sigmoid":
			if in.IsNull() {
				...
				if out.Sigmoid == nil {
					out.Sigmoid = new(SigmoidFunction)
				}
				if data := in.Raw(); in.Ok() {
					in.AddError((*out.Sigmoid).UnmarshalJSON(data))
				}
			}
		case "saturation":
			if in.IsNull() {
				...
				if out.Saturation == nil {
					out.Saturation = new(SaturationFunction)
				}
				if data := in.Raw(); in.Ok() {
					in.AddError((*out.Saturation).UnmarshalJSON(data))
				}
			}
		default:
			in.SkipRecursive()
...
func easyjson390b7126EncodeGithubComChancedPicker8(out *jwriter.Writer, in rankFeatureQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
	...
	if in.Log != nil {
		...
		out.Raw((*in.Log).MarshalJSON())
	}
	if in.Linear != nil {
		const prefix string = ",\"linear\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		out.Raw((*in.Linear).MarshalJSON())
	}
	if in.Sigmoid != nil {
		const prefix string = ",\"sigmoid\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		out.Raw((*in.Sigmoid).MarshalJSON())
	}
	if in.Saturation != nil {
		...
		out.Raw((*in.Saturation).MarshalJSON())
	}
	out.RawByte('}')
}
...
func easyjson390b7126DecodeGithubComChancedPicker9(in *jlexer.Lexer, out *queryStringQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker9(out *jwriter.Writer, in queryStringQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker10(in *jlexer.Lexer, out *prefixRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker10(out *jwriter.Writer, in prefixRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker11(in *jlexer.Lexer, out *percolateQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker11(out *jwriter.Writer, in percolateQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker12(in *jlexer.Lexer, out *parentIDQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker12(out *jwriter.Writer, in parentIDQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker13(in *jlexer.Lexer, out *numericRangeField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker13(out *jwriter.Writer, in numericRangeField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Coerce != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker14(in *jlexer.Lexer, out *nestedQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker14(out *jwriter.Writer, in nestedQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker15(in *jlexer.Lexer, out *moreLikeThisQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker15(out *jwriter.Writer, in moreLikeThisQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker16(in *jlexer.Lexer, out *matchRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker16(out *jwriter.Writer, in matchRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker17(in *jlexer.Lexer, out *matchPhraseQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker17(out *jwriter.Writer, in matchPhraseQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker18(in *jlexer.Lexer, out *matchPhrasePrefixQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker18(out *jwriter.Writer, in matchPhrasePrefixQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker19(in *jlexer.Lexer, out *matchBoolPrefixQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker19(out *jwriter.Writer, in matchBoolPrefixQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker20(in *jlexer.Lexer, out *logFunction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "scaling_factor":
			if m, ok := out.ScalingFactor.(easyjson.Unmarshaler); ok {
				m.UnmarshalEasyJSON(in)
			} else if m, ok := out.ScalingFactor.(json.Unmarshaler); ok {
				_ = m.UnmarshalJSON(in.Raw())
			} else {
				out.ScalingFactor = in.Interface()
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson390b7126EncodeGithubComChancedPicker20(out *jwriter.Writer, in logFunction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ScalingFactor != nil {
		const prefix string = ",\"scaling_factor\":"
		first = false
		out.RawString(prefix[1:])
		if m, ok := in.ScalingFactor.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.ScalingFactor.(json.Marshaler); ok {
			out.Raw(m.MarshalJSON())
		} else {
			out.Raw(json.Marshal(in.ScalingFactor))
		}
	}
	out.RawByte('}')
}
...
func easyjson390b7126DecodeGithubComChancedPicker21(in *jlexer.Lexer, out *joinField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "relations":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v16 dynamic.StringOrArrayOfStrings
					if data := in.Raw(); in.Ok() {
						in.AddError((v16).UnmarshalJSON(data))
					}
					(out.Relations)[key] = v16
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson390b7126EncodeGithubComChancedPicker21(out *jwriter.Writer, in joinField) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Relations) != 0 {
		...
		out.RawString(prefix[1:])
		{
			out.RawByte('{')
			v17First := true
			for v17Name, v17Value := range in.Relations {
				if v17First {
					v17First = false
				} else {
					out.RawByte(',')
...
func easyjson390b7126DecodeGithubComChancedPicker22(in *jlexer.Lexer, out *ipRangeField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker22(out *jwriter.Writer, in ipRangeField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Coerce != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker23(in *jlexer.Lexer, out *ipField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker23(out *jwriter.Writer, in ipField) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson390b7126DecodeGithubComChancedPicker24(in *jlexer.Lexer, out *idsQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "values":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Values = append(out.Values, v18)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson390b7126EncodeGithubComChancedPicker24(out *jwriter.Writer, in idsQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker25(in *jlexer.Lexer, out *histogramField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker25(out *jwriter.Writer, in histogramField) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker26(in *jlexer.Lexer, out *hasParentQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker26(out *jwriter.Writer, in hasParentQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
		const prefix string = ",\"parent_type\":"
		out.RawString(prefix[1:])
...
func easyjson390b7126DecodeGithubComChancedPicker27(in *jlexer.Lexer, out *hasChildQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "max_children":
			if m, ok := out.MaxChildren.(easyjson.Unmarshaler); ok {
				m.UnmarshalEasyJSON(in)
			} else if m, ok := out.MaxChildren.(json.Unmarshaler); ok {
				_ = m.UnmarshalJSON(in.Raw())
			} else {
				out.MaxChildren = in.Interface()
			}
		case "min_children":
			if m, ok := out.MinChildren.(easyjson.Unmarshaler); ok {
				m.UnmarshalEasyJSON(in)
			} else if m, ok := out.MinChildren.(json.Unmarshaler); ok {
				_ = m.UnmarshalJSON(in.Raw())
			} else {
				out.MinChildren = in.Interface()
			}
		case "score_mode":
			out.ScoreMode = ScoreMode(in.String())
		case "_name":
...
func easyjson390b7126EncodeGithubComChancedPicker27(out *jwriter.Writer, in hasChildQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Type != "" {
	...
	if in.MaxChildren != nil {
		...
		if m, ok := in.MaxChildren.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.MaxChildren.(json.Marshaler); ok {
			out.Raw(m.MarshalJSON())
		} else {
			out.Raw(json.Marshal(in.MaxChildren))
		}
	}
	if in.MinChildren != nil {
		const prefix string = ",\"min_children\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		if m, ok := in.MinChildren.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.MinChildren.(json.Marshaler); ok {
			out.Raw(m.MarshalJSON())
		} else {
			out.Raw(json.Marshal(in.MinChildren))
		}
	}
	if in.ScoreMode != "" {
		const prefix string = ",\"score_mode\":"
...
func easyjson390b7126DecodeGithubComChancedPicker28(in *jlexer.Lexer, out *geoShapeQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker28(out *jwriter.Writer, in geoShapeQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker29(in *jlexer.Lexer, out *geoShapeField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker29(out *jwriter.Writer, in geoShapeField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Orientation != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker30(in *jlexer.Lexer, out *geoPointField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker30(out *jwriter.Writer, in geoPointField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IgnoreMalformed != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker31(in *jlexer.Lexer, out *fuzzyRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker31(out *jwriter.Writer, in fuzzyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker32(in *jlexer.Lexer, out *flattenedField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker32(out *jwriter.Writer, in flattenedField) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson390b7126DecodeGithubComChancedPicker33(in *jlexer.Lexer, out *fieldValueFactorParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker33(out *jwriter.Writer, in fieldValueFactorParams) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Modifier != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker34(in *jlexer.Lexer, out *distanceFeatureQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker34(out *jwriter.Writer, in distanceFeatureQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker35(in *jlexer.Lexer, out *denseVectorField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker35(out *jwriter.Writer, in denseVectorField) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson390b7126DecodeGithubComChancedPicker36(in *jlexer.Lexer, out *dateRangeField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker36(out *jwriter.Writer, in dateRangeField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Coerce != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker37(in *jlexer.Lexer, out *dateField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker37(out *jwriter.Writer, in dateField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IgnoreMalformed != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker38(in *jlexer.Lexer, out *constantField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker38(out *jwriter.Writer, in constantField) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker39(in *jlexer.Lexer, out *completionField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker39(out *jwriter.Writer, in completionField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Analyzer != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker40(in *jlexer.Lexer, out *booleanField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker40(out *jwriter.Writer, in booleanField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DocValues != nil {
	...
	if len(in.Meta) != 0 {
		...
		}
		{
			out.RawByte('{')
			v24First := true
			for v24Name, v24Value := range in.Meta {
				if v24First {
					v24First = false
				} else {
					out.RawByte(',')
...
func easyjson390b7126DecodeGithubComChancedPicker41(in *jlexer.Lexer, out *binaryField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker41(out *jwriter.Writer, in binaryField) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DocValues != nil {
...
func easyjson390b7126DecodeGithubComChancedPicker42(in *jlexer.Lexer, out *anyOfRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker42(out *jwriter.Writer, in anyOfRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker43(in *jlexer.Lexer, out *allOfRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker43(out *jwriter.Writer, in allOfRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker44(in *jlexer.Lexer, out *aliasField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker44(out *jwriter.Writer, in aliasField) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker45(in *jlexer.Lexer, out *Vertices) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker45(out *jwriter.Writer, in Vertices) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker46(in *jlexer.Lexer, out *LatLon) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker46(out *jwriter.Writer, in LatLon) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker47(in *jlexer.Lexer, out *IndexedShape) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker47(out *jwriter.Writer, in IndexedShape) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker48(in *jlexer.Lexer, out *BoundingBox) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker48(out *jwriter.Writer, in BoundingBox) {
	out.RawByte('{')
	first := true
	_ = first
	{
