...
func easyjson390b7126DecodeGithubComChancedPicker42(in *jlexer.Lexer, out *LatLon) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker42(out *jwriter.Writer, in LatLon) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson390b7126DecodeGithubComChancedPicker43(in *jlexer.Lexer, out *IndexedShape) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker43(out *jwriter.Writer, in IndexedShape) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson390b7126DecodeGithubComChancedPicker44(in *jlexer.Lexer, out *BoundingBox) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson390b7126EncodeGithubComChancedPicker44(out *jwriter.Writer, in BoundingBox) {
	out.RawByte('{')
	first := true
	_ = first
	{
