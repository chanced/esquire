...
var (
	...
	ErrInvalidDynamic             = errors.New("picker: invalid dynamic value")
	ErrInvalidIndexOptions        = errors.New("picker: invalid index optionsvalue")
	...
	ErrInvalidMaxShingleSize      = errors.New("picker: invalid MaxShingleSize; valid values are [2,3,4]")
)
